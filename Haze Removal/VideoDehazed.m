...
path='E:\Matlab 2022\File\ComputerVision\Haze Removal\Dataset\张家界.mp4';   %待处理视频路径
Video=VideoReader(path);
num=Video.NumFrames;                 %获取视频帧数

% 创建视频对象并打开
% 处理后的视频保存地址
NewVideo=VideoWriter('E:\Matlab 2022\File\ComputerVision\Haze Removal\Results\result.mp4', 'MPEG-4');   
open(NewVideo);
...
for x=505:num
    ...
    imshow(J);
    writeVideo(NewVideo,mat2gray(J));
    disp("ok")
end 
